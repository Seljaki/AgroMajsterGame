...
public class RegionNames {
    ...
    public static final String MAGPIE_SPRITE_LEFT_3 = "magpieSpriteLeft3";
    public static final String MAGPIE_SPRITE_LEFT_4 = "magpieSpriteLeft4";
    public static final String MAGPIE_SPRITE_LEFT_5 = "magpieSpriteLeft5";
    public static final String MAGPIE_SPRITE_LEFT_6 = "magpieSpriteLeft6";
    public static final String MAGPIE_SPRITE_LEFT_7 = "magpieSpriteLeft7";
    public static final String MAGPIE_SPRITE_LEFT_8 = "magpieSpriteLeft8";
    public static final String MAGPIE_SPRITE_LEFT_9 = "magpieSpriteLeft9";
    public static final String MAGPIE_SPRITE_LEFT_10 = "magpieSpriteLeft10";
    public static final String MAGPIE_SPRITE_LEFT_11 = "magpieSpriteLeft11";
    public static final String MAGPIE_SPRITE_LEFT_12 = "magpieSpriteLeft12";
    public static final String MAGPIE_SPRITE_RIGHT_1 = "magpieSpriteRight1";
    public static final String MAGPIE_SPRITE_RIGHT_2 = "magpieSpriteRight2";
    public static final String MAGPIE_SPRITE_RIGHT_3 = "magpieSpriteRight3";
    public static final String MAGPIE_SPRITE_RIGHT_4 = "magpieSpriteRight4";
    public static final String MAGPIE_SPRITE_RIGHT_5 = "magpieSpriteRight5";
    public static final String MAGPIE_SPRITE_RIGHT_6 = "magpieSpriteRight6";
    public static final String MAGPIE_SPRITE_RIGHT_7 = "magpieSpriteRight7";
    public static final String MAGPIE_SPRITE_RIGHT_8 = "magpieSpriteRight8";
    ...
    public static final String[] MAGPIE_SPRITES_LEFT = {
        ...
        MAGPIE_SPRITE_LEFT_2,
        MAGPIE_SPRITE_LEFT_3,
        MAGPIE_SPRITE_LEFT_4,
        MAGPIE_SPRITE_LEFT_5,
        MAGPIE_SPRITE_LEFT_6,
        MAGPIE_SPRITE_LEFT_7,
        MAGPIE_SPRITE_LEFT_8,
        MAGPIE_SPRITE_LEFT_9,
        MAGPIE_SPRITE_LEFT_10,
        MAGPIE_SPRITE_LEFT_11,
        MAGPIE_SPRITE_LEFT_12
    };
    public static final String[] MAGPIE_SPRITES_RIGHT = {
        MAGPIE_SPRITE_RIGHT_1,
        MAGPIE_SPRITE_RIGHT_2,
        MAGPIE_SPRITE_RIGHT_3,
        MAGPIE_SPRITE_RIGHT_4,
        MAGPIE_SPRITE_RIGHT_5,
        MAGPIE_SPRITE_RIGHT_6,
        MAGPIE_SPRITE_RIGHT_7,
        MAGPIE_SPRITE_RIGHT_8,
        MAGPIE_SPRITE_RIGHT_9,
